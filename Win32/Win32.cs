...
namespace pi
{
    public class Win32
    {
        ...
        public static extern IntPtr OpenProcess(
            PROCESS_ACCESS_FLAGS processAccess,
            bool bInheritHandle,
            int processId
        );
        ...
        public static extern IntPtr OpenThread(
            THREAD_ACCESS_FLAGS dwDesiredAccess,
            bool bInheritHandle,
            int dwThreadId
        );
        ...
        public static extern HRESULT SetThreadDescription(
            IntPtr hThread,
            byte[] lpThreadDescription //[MarshalAs(UnmanagedType.LPWStr)] string
        );
        ...
        public static extern NTSTATUS NtQueueApcThreadEx2(
            IntPtr threadHandle,
            IntPtr UserApcReserveHandle,
            [MarshalAs(UnmanagedType.U4)] QUEUE_USER_APC_FLAGS QueueUserApcFlags,
            IntPtr ApcRoutine,
            IntPtr SystemArg1,
            IntPtr SystemArg2,
            IntPtr SystemArg3
        ...
        public static extern int RtlInitUnicodeStringEx(ref UNICODE_STRING DestinationString, IntPtr SourceString);

        [DllImport("ntdll.dll")]
        public static extern int NtSetInformationThread(
            IntPtr ThreadHandle,
            ThreadInformationClass ThreadInformationClass,
            ref UNICODE_STRING ThreadInformation,
            uint ThreadInformationLength
        );

        [DllImport("ntdll.dll", SetLastError = true)]
        public static extern Win32.NTSTATUS NtQueryInformationProcess(
        ...
        {
            public Win32.NTSTATUS ExitStatus;
        ...
        [Flags]
        public enum THREAD_ACCESS_FLAGS : long
        {
